...
public class ForgotPasswordWindow extends JFrame{
	 ...
	 * the remind me button is searching the user's room on the first JOptionPane
	 * and matching it with the email address. If the email address he entered on the next JOptionPane window is correct 
	 * then the email along with the password is sent.
	 */
